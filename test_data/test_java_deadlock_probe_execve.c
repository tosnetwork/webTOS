/*
 * test_java_deadlock_probe_execve.c — Launch the isolated Java deadlock probe.
 */
...
void _start(void) {
    ...
    static char arg3[] = "-Xint";
    static char arg4[] = "-XX:-UseCompiler";
    static char arg5[] = "-cp";
    static char arg6[] = "/usr/lib/tos-tests";
    static char arg7[] = "JavaAnnotationDeadlockProbe";
    ...
    static char *argv[] = {arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, 0};
    static char *envp[] = {env0, env1, env2, env3, env4, 0};

    print("[JAVA] launching deadlock probe\n");
    long ret = sys_execve(path, argv, envp);
    print("[JAVA] deadlock probe execve returned ");
    print_num(ret);
    print("\n");
    sys_exit(1);
}
