 ...
 *          ["java", "-Xshare:off", "-XX:-UsePerfData", "-cp", "/usr/lib/tos-tests", "Hello"], envp)
 *
 * Success is observed if the VM prints "TOS-JAVA-HELLO" and exits cleanly.
 */
...
void _start(void) {
    ...
    print("[JAVA] launching java -Xshare:off -XX:-UsePerfData -cp /usr/lib/tos-tests Hello\n");
