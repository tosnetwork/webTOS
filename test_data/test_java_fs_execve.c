/*
 * test_java_fs_execve.c — Smoke test for Java file and directory access.
 *
 * Build:
 *   gcc -nostdlib -static -Os -s -Wl,-Ttext=0x40000000 -o test_java_fs_execve.elf test_java_fs_execve.c
 *
 * Runs:
