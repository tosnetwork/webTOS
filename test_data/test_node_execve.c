/*
 * test_node_execve.c — Smoke test for host-installed Node.js in base image.
 *
 * Build:
 *   gcc -nostdlib -static -Os -s -Wl,-Ttext=0x40000000 -o test_node_execve.elf test_node_execve.c
 *
 * This binary performs:
 *   execve("/usr/bin/node", ["node", "-e", "console.log(1)"], envp)
 *
 * Success is observed if Node prints "1" and exits cleanly.
 */
