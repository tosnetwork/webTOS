...
pub(super) fn execute_numeric(inst: &mut WasmInstance, opcode: u8) -> ExecResult {
    ...
    match opcode {
        ...
        0x8B => {
            ...
            let a = try_exec!(inst.pop_f32());
            try_exec!(inst.push(Value::F32(libm::fabsf(a))));
        }
        0x8C => {
            if inst.runtime_class == RuntimeClass::ProofGrade {
                return ExecResult::Trap(WasmError::FloatsDisabled);
            ...
            let a = try_exec!(inst.pop_f32());
            try_exec!(inst.push(Value::F32(-a)));
        }
        0x8D => {
            if inst.runtime_class == RuntimeClass::ProofGrade {
                return ExecResult::Trap(WasmError::FloatsDisabled);
            ...
            let a = try_exec!(inst.pop_f32());
            try_exec!(inst.push(Value::F32(WasmInstance::wasm_ceil_f32(a))));
        }
        0x8E => {
            if inst.runtime_class == RuntimeClass::ProofGrade {
                return ExecResult::Trap(WasmError::FloatsDisabled);
            ...
            let a = try_exec!(inst.pop_f32());
            try_exec!(inst.push(Value::F32(WasmInstance::wasm_floor_f32(a))));
        }
        0x8F => {
            if inst.runtime_class == RuntimeClass::ProofGrade {
                return ExecResult::Trap(WasmError::FloatsDisabled);
            ...
            let a = try_exec!(inst.pop_f32());
            try_exec!(inst.push(Value::F32(WasmInstance::wasm_trunc_f32(a))));
        }
        0x90 => {
            if inst.runtime_class == RuntimeClass::ProofGrade {
                return ExecResult::Trap(WasmError::FloatsDisabled);
            ...
            let a = try_exec!(inst.pop_f32());
            try_exec!(inst.push(Value::F32(WasmInstance::wasm_nearest_f32(a))));
        }
        0x91 => {
            if inst.runtime_class == RuntimeClass::ProofGrade {
                return ExecResult::Trap(WasmError::FloatsDisabled);
            ...
            let a = try_exec!(inst.pop_f32());
            try_exec!(inst.push(Value::F32(WasmInstance::wasm_sqrt_f32(a))));
        }
        ...
        0x92 => {
            ...
            let b = try_exec!(inst.pop_f32());
            let a = try_exec!(inst.pop_f32());
            try_exec!(inst.push(Value::F32(a + b)));
        }
        0x93 => {
            if inst.runtime_class == RuntimeClass::ProofGrade {
                return ExecResult::Trap(WasmError::FloatsDisabled);
        ...
        0x96 => {
            ...
            let b = try_exec!(inst.pop_f32());
            let a = try_exec!(inst.pop_f32());
            try_exec!(inst.push(Value::F32(WasmInstance::wasm_min_f32(a, b))));
        }
        0x97 => {
            if inst.runtime_class == RuntimeClass::ProofGrade {
                return ExecResult::Trap(WasmError::FloatsDisabled);
            ...
            let b = try_exec!(inst.pop_f32());
            let a = try_exec!(inst.pop_f32());
            try_exec!(inst.push(Value::F32(WasmInstance::wasm_max_f32(a, b))));
        }
        0x98 => {
            if inst.runtime_class == RuntimeClass::ProofGrade {
                return ExecResult::Trap(WasmError::FloatsDisabled);
            ...
            let b = try_exec!(inst.pop_f32());
            let a = try_exec!(inst.pop_f32());
            try_exec!(inst.push(Value::F32(libm::copysignf(a, b))));
        }
        ...
        0x99 => {
            ...
            let a = try_exec!(inst.pop_f64());
            try_exec!(inst.push(Value::F64(libm::fabs(a))));
        }
        0x9A => {
            if inst.runtime_class == RuntimeClass::ProofGrade {
                return ExecResult::Trap(WasmError::FloatsDisabled);
            ...
            let a = try_exec!(inst.pop_f64());
            try_exec!(inst.push(Value::F64(-a)));
        }
        0x9B => {
            if inst.runtime_class == RuntimeClass::ProofGrade {
                return ExecResult::Trap(WasmError::FloatsDisabled);
            ...
            let a = try_exec!(inst.pop_f64());
            try_exec!(inst.push(Value::F64(WasmInstance::wasm_ceil_f64(a))));
        }
        0x9C => {
            if inst.runtime_class == RuntimeClass::ProofGrade {
                return ExecResult::Trap(WasmError::FloatsDisabled);
            ...
            let a = try_exec!(inst.pop_f64());
            try_exec!(inst.push(Value::F64(WasmInstance::wasm_floor_f64(a))));
        }
        0x9D => {
            if inst.runtime_class == RuntimeClass::ProofGrade {
                return ExecResult::Trap(WasmError::FloatsDisabled);
            ...
            let a = try_exec!(inst.pop_f64());
            try_exec!(inst.push(Value::F64(WasmInstance::wasm_trunc_f64(a))));
        }
        0x9E => {
            if inst.runtime_class == RuntimeClass::ProofGrade {
                return ExecResult::Trap(WasmError::FloatsDisabled);
            ...
            let a = try_exec!(inst.pop_f64());
            try_exec!(inst.push(Value::F64(WasmInstance::wasm_nearest_f64(a))));
        }
        0x9F => {
            if inst.runtime_class == RuntimeClass::ProofGrade {
                return ExecResult::Trap(WasmError::FloatsDisabled);
            ...
            let a = try_exec!(inst.pop_f64());
            try_exec!(inst.push(Value::F64(WasmInstance::wasm_sqrt_f64(a))));
        }
        ...
        0xA0 => {
            ...
            let b = try_exec!(inst.pop_f64());
            let a = try_exec!(inst.pop_f64());
            try_exec!(inst.push(Value::F64(a + b)));
        }
        0xA1 => {
            if inst.runtime_class == RuntimeClass::ProofGrade {
                return ExecResult::Trap(WasmError::FloatsDisabled);
        ...
        0xA4 => {
            ...
            let b = try_exec!(inst.pop_f64());
            let a = try_exec!(inst.pop_f64());
            try_exec!(inst.push(Value::F64(WasmInstance::wasm_min_f64(a, b))));
        }
        0xA5 => {
            if inst.runtime_class == RuntimeClass::ProofGrade {
                return ExecResult::Trap(WasmError::FloatsDisabled);
            ...
            let b = try_exec!(inst.pop_f64());
            let a = try_exec!(inst.pop_f64());
            try_exec!(inst.push(Value::F64(WasmInstance::wasm_max_f64(a, b))));
        }
        0xA6 => {
            if inst.runtime_class == RuntimeClass::ProofGrade {
                return ExecResult::Trap(WasmError::FloatsDisabled);
            ...
            let b = try_exec!(inst.pop_f64());
            let a = try_exec!(inst.pop_f64());
            try_exec!(inst.push(Value::F64(libm::copysign(a, b))));
        }
        ...
        0xA8 => {
            ...
            let a = try_exec!(inst.pop_f32());
            if a.is_nan() {
                return ExecResult::Trap(WasmError::InvalidConversionToInteger);
            }
            if a <= -2147483904.0_f32 || a >= 2147483648.0_f32 {
                return ExecResult::Trap(WasmError::IntegerOverflow);
            }
            try_exec!(inst.push(Value::I32(a as i32)));
        }
        0xA9 => {
            ...
            if a <= -1.0_f32 || a >= 4294967296.0_f32 {
                return ExecResult::Trap(WasmError::IntegerOverflow);
            }
            try_exec!(inst.push(Value::I32(a as u32 as i32)));
        }
        0xAA => {
            if inst.runtime_class == RuntimeClass::ProofGrade {
                return ExecResult::Trap(WasmError::FloatsDisabled);
            ...
            if a <= -2147483649.0_f64 || a >= 2147483648.0_f64 {
                return ExecResult::Trap(WasmError::IntegerOverflow);
            }
            try_exec!(inst.push(Value::I32(a as i32)));
        }
        0xAB => {
            ...
            if a <= -1.0_f64 || a >= 4294967296.0_f64 {
                return ExecResult::Trap(WasmError::IntegerOverflow);
            }
            try_exec!(inst.push(Value::I32(a as u32 as i32)));
        }
        0xAE => {
            ...
            if a <= -9223373136366403584.0_f32 || a >= 9223372036854775808.0_f32 {
                return ExecResult::Trap(WasmError::IntegerOverflow);
            }
            try_exec!(inst.push(Value::I64(a as i64)));
        }
        0xAF => {
            ...
            if a <= -1.0_f32 || a >= 18446744073709551616.0_f32 {
                return ExecResult::Trap(WasmError::IntegerOverflow);
            }
            try_exec!(inst.push(Value::I64(a as u64 as i64)));
        }
        0xB0 => {
            if inst.runtime_class == RuntimeClass::ProofGrade {
                return ExecResult::Trap(WasmError::FloatsDisabled);
            ...
            if a <= -9223372036854777856.0_f64 || a >= 9223372036854775808.0_f64 {
                return ExecResult::Trap(WasmError::IntegerOverflow);
            }
            try_exec!(inst.push(Value::I64(a as i64)));
        }
        0xB1 => {
            ...
            if a <= -1.0_f64 || a >= 18446744073709551616.0_f64 {
                return ExecResult::Trap(WasmError::IntegerOverflow);
            }
            try_exec!(inst.push(Value::I64(a as u64 as i64)));
        }
        ...
        0xB2 => {
            ...
            let a = try_exec!(inst.pop_i32());
            try_exec!(inst.push(Value::F32(a as f32)));
        }
        0xB3 => {
            if inst.runtime_class == RuntimeClass::ProofGrade {
                return ExecResult::Trap(WasmError::FloatsDisabled);
            ...
            let a = try_exec!(inst.pop_i32());
            try_exec!(inst.push(Value::F32((a as u32) as f32)));
        }
        0xB4 => {
            if inst.runtime_class == RuntimeClass::ProofGrade {
                return ExecResult::Trap(WasmError::FloatsDisabled);
        ...
        0xB5 => {
            ...
            let a = try_exec!(inst.pop_i64());
            try_exec!(inst.push(Value::F32((a as u64) as f32)));
        }
        0xB6 => {
            if inst.runtime_class == RuntimeClass::ProofGrade {
                return ExecResult::Trap(WasmError::FloatsDisabled);
        ...
        0xB7 => {
            ...
            let a = try_exec!(inst.pop_i32());
            try_exec!(inst.push(Value::F64(a as f64)));
        }
        0xB8 => {
            if inst.runtime_class == RuntimeClass::ProofGrade {
                return ExecResult::Trap(WasmError::FloatsDisabled);
            ...
            let a = try_exec!(inst.pop_i32());
            try_exec!(inst.push(Value::F64((a as u32) as f64)));
        }
        0xB9 => {
            if inst.runtime_class == RuntimeClass::ProofGrade {
                return ExecResult::Trap(WasmError::FloatsDisabled);
        ...
        0xBA => {
            ...
            let a = try_exec!(inst.pop_i64());
            try_exec!(inst.push(Value::F64((a as u64) as f64)));
        }
        0xBB => {
            if inst.runtime_class == RuntimeClass::ProofGrade {
                return ExecResult::Trap(WasmError::FloatsDisabled);
        ...
        0xBC => {
            ...
            let a = try_exec!(inst.pop_f32());
            try_exec!(inst.push(Value::I32(a.to_bits() as i32)));
        }
        0xBD => {
            if inst.runtime_class == RuntimeClass::ProofGrade {
                return ExecResult::Trap(WasmError::FloatsDisabled);
            ...
            let a = try_exec!(inst.pop_f64());
            try_exec!(inst.push(Value::I64(a.to_bits() as i64)));
        }
        0xBE => {
            if inst.runtime_class == RuntimeClass::ProofGrade {
                return ExecResult::Trap(WasmError::FloatsDisabled);
            ...
            let a = try_exec!(inst.pop_i32());
            try_exec!(inst.push(Value::F32(f32::from_bits(a as u32))));
        }
        0xBF => {
            if inst.runtime_class == RuntimeClass::ProofGrade {
                return ExecResult::Trap(WasmError::FloatsDisabled);
            ...
            let a = try_exec!(inst.pop_i64());
            try_exec!(inst.push(Value::F64(f64::from_bits(a as u64))));
        }
