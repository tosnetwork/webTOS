...
impl WasmInstance {
    ...
    pub(crate) fn read_f32(&mut self) -> Result<f32, WasmError> {
        ...
        let bytes = [
            ...
            self.module.code[self.pc + 1],
            self.module.code[self.pc + 2],
            self.module.code[self.pc + 3],
        ];
        self.pc += 4;
