        ...
        while self.pc < self.end {
            ...
            match opcode {
                ...
                0x11 => {
                    ...
                    if !matches!(tbl_et, ValType::FuncRef | ValType::TypedFuncRef | ValType::NonNullableFuncRef | ValType::NullableTypedFuncRef) {
                        return Err(WasmError::TypeMismatch);
                    }
                ...
                0xFB => {
                    ...
                    match sub {
                        ...
                        2 | 3 | 4 => { // struct.get/get_s/get_u: typeidx fieldidx — pop ref, push val
                            ...
                            let field_vt = if let Some(GcTypeDef::Struct { ref field_types, .. }) = self.module.gc_types.get(type_idx as usize) {
                        ...
                        5 => { // struct.set: typeidx fieldidx — pop ref, pop val
                            ...
                            if let Some(GcTypeDef::Struct { field_muts, .. }) = self.module.gc_types.get(type_idx as usize) {
                        ...
                        14 => { // array.set: typeidx — pop val, pop idx, pop ref
                            ...
                            if let Some(GcTypeDef::Array { elem_mutable, .. }) = self.module.gc_types.get(type_idx as usize) {
                        ...
                        16 => { // array.fill: typeidx — pop len, pop val, pop idx, pop ref
                            ...
                            if let Some(GcTypeDef::Array { elem_mutable, ref elem_type }) = self.module.gc_types.get(type_idx as usize) {
                                if !elem_mutable { return Err(WasmError::TypeMismatch); }
                        ...
                        17 => { // array.copy: dst_typeidx + src_typeidx — pop len, pop src_idx, pop src_ref, pop dst_idx, pop dst_ref
                            ...
                            if let Some(GcTypeDef::Array { elem_mutable, .. }) = self.module.gc_types.get(dst_type as usize) {
                                if !elem_mutable { return Err(WasmError::TypeMismatch); }
                            }
