...
fn is_type_index_subtype(src: u32, dst: u32, module: &WasmModule) -> bool {
    if src == dst { return true; }
...
fn storage_types_rec_eq(
    module: &WasmModule, a: &crate::wasm::decoder::StorageType, rg_a: u32,
    b: &crate::wasm::decoder::StorageType, rg_b: u32, rg_size: u32, depth: u32,
) -> bool {
    use crate::wasm::decoder::StorageType;
    match (a, b) {
...
fn validate_function_body(
    ...
    let safe_local_count = (func.local_count as usize).min(crate::wasm::types::MAX_LOCALS);
