        ...
        match opcode {
            ...
            0xFD => {
                ...
                match simd_op {
                    ...
                    0xba => { let b = try_exec!(self.pop_v128()); let a = try_exec!(self.pop_v128()); let (aa,bb) = (a.as_i16x8(), b.as_i16x8()); let r: [i32; 4] = core::array::from_fn(|i| ((aa[i*2] as i32)*(bb[i*2] as i32)).wrapping_add((aa[i*2+1] as i32)*(bb[i*2+1] as i32))); try_exec!(self.push(Value::V128(V128::from_i32x4(r)))); }
