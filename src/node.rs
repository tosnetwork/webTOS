...
/// Return a 32-byte node identifier derived from the legacy 32-bit node ID.
///
/// The first 4 bytes contain the legacy ID; the remaining 28 are zero-padded.
/// This is used by subsystems (e.g. checkpointing) that need a `[u8; 32]`.
