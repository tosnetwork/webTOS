...
fn dispatch_file_syscall(
    ...
    let result = match num {
        ...
        // Deterministic no-op advice. The file object model remains stable
        // without feeding host VM hints back into scheduling policy.
        SYS_FADVISE64 => 0,
        ...
        SYS_UTIMENSAT => fs::sys_utimensat(agent_id, a1 as i32, a2, a3, a4 as u32),
        SYS_RENAMEAT => fs::sys_renameat(agent_id, a1 as i32, a2, a3 as i32, a4),
        SYS_SYMLINKAT => fs::sys_symlinkat(agent_id, a1, a2 as i32, a3),
...
fn dispatch_process_syscall(
    ...
    let result = match num {
        ...
        SYS_WAITID => process::sys_waitid(agent_id, a1 as u32, a2, a3, a4 as u32, a5),
        ...
        SYS_SCHED_SETPARAM => process::sys_sched_setparam(agent_id, a1 as i32, a2),
        SYS_SCHED_GETPARAM => process::sys_sched_getparam(agent_id, a1 as i32, a2),
        SYS_SCHED_SETSCHEDULER => {
            process::sys_sched_setscheduler(agent_id, a1 as i32, a2 as i32, a3)
        }
        SYS_SCHED_GETSCHEDULER => process::sys_sched_getscheduler(agent_id, a1 as i32),
...
fn dispatch_network_syscall(
    ...
    let result = match num {
        ...
        SYS_ACCEPT4 => network::sys_accept4(agent_id, a1 as i32, a2, a3, a4),
...
fn dispatch_identity_syscall(
    ...
    let result = match num {
        ...
        SYS_SETSID => identity::sys_setsid(agent_id),
        SYS_GETPGID => identity::sys_getpgid(agent_id, a1),
        SYS_GETSID => identity::sys_getsid(agent_id, a1),
        ...
        SYS_UMASK => identity::sys_umask(agent_id, a1 as u32),
