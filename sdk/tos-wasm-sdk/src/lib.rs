...
//! TOS WASM Agent SDK
//!
//! Write WASM agents for TOS in Rust. This crate provides safe wrappers
//! around the TOS WASM host functions.
//!
//! # Example
//! ```rust,ignore
//! #![no_std]
...
// ─── Host function imports (provided by TOS WASM runtime) ───────────

#[link(wasm_import_module = "tos")]
extern "C" {
    #[link_name = "sys_yield"]
...
/// Log a string to TOS serial output.
