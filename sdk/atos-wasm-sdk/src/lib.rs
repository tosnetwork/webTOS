...
//! ATOS WASM Agent SDK
//!
//! Write WASM agents for ATOS in Rust. This crate provides safe wrappers
//! around the ATOS WASM host functions.
//!
//! # Example
//! ```rust,ignore
//! #![no_std]
...
// ─── Host function imports (provided by ATOS WASM runtime) ───────────

#[link(wasm_import_module = "atos")]
extern "C" {
    #[link_name = "sys_yield"]
...
/// Log a string to ATOS serial output.
