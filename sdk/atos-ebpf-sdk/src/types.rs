//! eBPF-lite instruction types and opcode constants.
//!
//! Mirrors `src/ebpf/types.rs` from the ATOS kernel — kept in sync manually.
//! This is a host-side copy used by the assembler, verifier, and disassembler.

/// eBPF-lite register count: r0-r10 (r10 = frame pointer, read-only).
...
pub struct Insn {
    pub opcode: u8,
    pub regs: u8,  // dst:4 (low) | src:4 (high)
    pub off: i16,
    pub imm: i32,
}
...
// ---------------------------------------------------------------------------
// Jump operations (opcode & 0xF0, JMP class)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Memory sizes (opcode & 0x18, LD/ST classes)
// ---------------------------------------------------------------------------
