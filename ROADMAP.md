...
- Fuzz instruction decoding, memory translation, ELF loading, syscalls, image
  parsing, snapshot restore, and browser messages. 🔶 (five of seven surfaces
  ...
  three more defects. Image parsing and browser messages have nothing)
