...
| M5 Event loop & networking | 13% | 96% | 12.5 |
| M6 OpenFox | 12% | 96% | 11.5 |
| M7 Codex & Claude Code | 20% | 84% | 16.8 |
| M8 Performance & release | 14% | 61% | 8.5 |
| **Total** | **100%** | | **87.4** |
...
- A long-running event loop survives transient network failure and browser
  ...
  `tests/suspend.rs`. Transient network failure has the interrupted-call gate
  but not reconnect)
