...
- Fuzz instruction decoding, memory translation, ELF loading, syscalls, image
  parsing, snapshot restore, and browser messages. 🔶 (four of seven surfaces
  ...
  decoder reads what it was not given: 365,568 sequences, no panics. Memory
  translation, image parsing, and browser messages have nothing)
