...
pub(crate) struct Regs {
    ...
    pub rbx: pcode::VarNode,
    pub rcx: pcode::VarNode,
    pub rdx: pcode::VarNode,
    pub rsi: pcode::VarNode,
    pub rdi: pcode::VarNode,
    pub rbp: pcode::VarNode,
    pub rsp: pcode::VarNode,
    pub r8: pcode::VarNode,
    pub r9: pcode::VarNode,
    pub r10: pcode::VarNode,
    pub r11: pcode::VarNode,
    pub r12: pcode::VarNode,
    pub r13: pcode::VarNode,
    pub r14: pcode::VarNode,
    pub r15: pcode::VarNode,
    pub rflags: pcode::VarNode,
